    ...
    JsonSchemaGenerator.prototype.getClassDefinition = function (clazzType, definition) {
        ...
        if (modifierFlags & ts.ModifierFlags.Abstract && this.inheritingTypes[fullName]) {
            ...
            if (clazz.members) {
                ...
                var recordNode = (_c = (_b = (_a = clazzType === null || clazzType === void 0 ? void 0 : clazzType.aliasSymbol) === null || _a === void 0 ? void 0 : _a.declarations) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.type;
                if (((_d = recordNode === null || recordNode === void 0 ? void 0 : recordNode.typeName) === null || _d === void 0 ? void 0 : _d.escapedText) === 'Record') {
                    var recordTypeNode = (_e = recordNode.typeArguments) === null || _e === void 0 ? void 0 : _e[1];
                    if (recordTypeNode) {
                        var typ = this.tc.getTypeAtLocation(recordTypeNode);
                        var def = this.getTypeDefinition(typ, undefined, "anyOf");
                        definition.type = "object";
                        definition.additionalProperties = def;
                    }
